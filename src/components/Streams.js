...
function Stream() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await twitchApi.get("https://api.twitch.tv/helix/streams");
      ...
      let gameNames = await twitchApi.get(finalURL);
    ...
    <div>
      ...
      <div className="row">
        {channels.map(channel => (
          <div className="col-lg-4 col-md-6 col-sm-12 mt-5" key={channel.id}>
            <div className="card">
              <img
